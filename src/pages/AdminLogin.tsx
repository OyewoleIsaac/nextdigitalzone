...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary via-secondary to-secondary/95 p-4">
      {/* Background Pattern */}
      ...
      <Card className="w-full max-w-md shadow-xl animate-fade-in-up relative z-10">
