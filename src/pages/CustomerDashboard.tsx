...
import { Hammer, LogOut, Loader2, Search, ClipboardList, User, CreditCard, Star, AlertTriangle, Shield, Clock, Wallet, ArrowDownLeft, ArrowUpRight } from 'lucide-react';
...
import { useWalletBalance, useWalletTransactions, usePayWithWalletCredit } from '@/hooks/useWallet';
...
const CustomerDashboard = () => {
  ...
  const { data: walletTxns = [] } = useWalletTransactions();
